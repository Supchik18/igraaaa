...
proshanie = f"Тогда ты мне не годишься, прощай!"
print ("Вы уже бывалый инквизитор, ваш меч повидал немало разных существ, таких как вампиров или даже демонов, однако несмотря н это утро у вас всегда тяжёлое")
time.sleep(2)
print("Ваш товарищ, юный маг спит на койке рядом... он очень утомился после нового приключения ")
time.sleep(3)
...
if a == 1:
    ...
    orudie = input()
    time.sleep(2)
    print("-Прекрасно,", (orudie), "Но однако это всё же ближний бой... я больше по дальнему, однако... ты сильно боишься демонов?")
...
if boish == 1:
    print(proshanie)
    time.sleep(2)
    print("Девушка растворяется в воздухе... кажется вы упустили что то важное... игра закончена: плохая концовка")
...
if boish == 2:
    ...
    if a == 2:
        print(proshanie)
        time.sleep(2)
        print("Вы слишком сильно боитесь... вы проиграли... Плохая концовка")
    ...
    if a == 1:
        ...
        if q == 1:
            ...
            time.sleep(1)
            print("Вы умерли... плохая концовка...")
        ...
        if q == 3:
            ...
            time.sleep(1)
            print("Вы стали марионеткой демонов... плохая концовка?")
